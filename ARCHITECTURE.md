# System Architecture: My Assisstance

## 1. Overview

My Assisstance is a full-stack application designed to bridge AI capabilities (via Groq/Gemini) with external messaging platforms (Telegram, Messenger) and persistent logging (Notion).
